...
export class Migration1771921956463 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "tag" ("id" SERIAL NOT NULL, "name" character varying(100) NOT NULL, CONSTRAINT "PK_8e4052373c579afc1471f526760" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "ad" ("id" SERIAL NOT NULL, "title" character varying(100) NOT NULL, "price" double precision NOT NULL, "description" text, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "location" character varying(50) NOT NULL, "pictureUrl" character varying NOT NULL, "categoryId" integer, "authorId" integer, CONSTRAINT "PK_0193d5ef09746e88e9ea92c634d" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "tag_ads_ad" ("tagId" integer NOT NULL, "adId" integer NOT NULL, CONSTRAINT "PK_9770ca45fa10ed4f02593be766c" PRIMARY KEY ("tagId", "adId"))`);
        ...
        await queryRunner.query(`ALTER TABLE "ad" ADD CONSTRAINT "FK_c418809c6e081f861cefe495668" FOREIGN KEY ("categoryId") REFERENCES "category"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "ad" ADD CONSTRAINT "FK_ee93b44ac1911e95b7026881c28" FOREIGN KEY ("authorId") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "tag_ads_ad" ADD CONSTRAINT "FK_9af5c0789da7135949e01590d0e" FOREIGN KEY ("tagId") REFERENCES "tag"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "tag_ads_ad" ADD CONSTRAINT "FK_2e21c616c1e011ddc661cab145f" FOREIGN KEY ("adId") REFERENCES "ad"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "tag_ads_ad" DROP CONSTRAINT "FK_2e21c616c1e011ddc661cab145f"`);
        await queryRunner.query(`ALTER TABLE "tag_ads_ad" DROP CONSTRAINT "FK_9af5c0789da7135949e01590d0e"`);
        await queryRunner.query(`ALTER TABLE "ad" DROP CONSTRAINT "FK_ee93b44ac1911e95b7026881c28"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_2e21c616c1e011ddc661cab145"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_9af5c0789da7135949e01590d0"`);
